class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "0110be03113753e804918ad55ebe140e3ec0f52dd2d7feb0ec208cfd1c977bb5"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "140b03bb41ea7a53b391469d8796da1c7f21126077e7f027766a964068b3eb39"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "c715a7064e461abc53f65b630e304243529eb4e48ca441a19f1a04d4fb181632"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "eeb91723030f2ac644741fbf366effaa0076c2828ea0fa1821372f4b0298e75e"
    end
  end
