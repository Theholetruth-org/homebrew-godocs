class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "e75911561e6ac9cd5b17a3c14a14bb7300c82db93a7edacf85a89feebc1f0cd7"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "03557d46e47cbff0662ae04f4acacb70f7ad4c3177b271b45d2267a6aae1c62c"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "6ac8aeee959299302c43bf689e5a003d51cc0329f9520222a59be9454418c665"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "ab7df2e87f023003bf406f794f7e02cd6d88cba90803b907872285668bf32cdc"
    end
  end
