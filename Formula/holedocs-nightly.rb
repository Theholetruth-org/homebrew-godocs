class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "c7a6c91607c83bbdca04bb0416df4a8b08077a35c4aabf0ba6b99846024cac24"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "46dee3b23fb2c70100bd968be5d297b30419f577a429c5b18193450e2114205f"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "094e93a1126b640efe94cd6984f9d8b7da805a9cef633703635c2cd58fda145a"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "c328eeb22b066be88eaf6379ab9588b12ec09976096bc303fd3a9333d8813f5e"
    end
  end
