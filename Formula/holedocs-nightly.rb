class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "300a9c44a33554f5a719f3d72eca74314dfe8071cacf52912483eb72a43dba9c"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "73d02287dde88ad455eb1fd789d69a9d4e7b5a547b7c2a6b378a57e65510803c"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "689e79ddfc4e1539fd9d3e72c3e93c9f9e712f09a100158f2321eec5a79b137a"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "51fb1ad0e9a68ae9cd654f9e78bb25ac7fc0fd674c98b1ada0d9687223fecae8"
    end
  end
