class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "b584774f4878deaf560b287e238097cc8cc2edd0924bfb234e65cd8e7b533763"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "88cff3e6af6e9ee6857c2198bc5a5271e4f3b90706e63d66325f82376b07cf7b"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "ac3617873030f9c9e2b413c6fbace31185a9b46406875f767bd36765d5be054a"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "b4240f6a316ea688393faadf192403f4819de54152c95e3bbb07a202ecc9a55c"
    end
  end
