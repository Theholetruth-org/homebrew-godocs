class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "e9732cdfe08f98c04a307a1908dbf6f351e6aded96dbbac02bbf7fdb2bab3828"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "b5c16bd1c0d1028e48771564378f0ffa8bf8c5bf7cfd942d4b44118bda82e0a5"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "b390b8bb8731feaf32075566cc3d387b6f8479656a12f31fe3adccdadaba9285"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "c1ddb6a8173c46ab1129c70b4dadc833cd47e9e365009fa01f41f23c9fbaf8e4"
    end
  end
