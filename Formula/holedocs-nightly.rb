class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "9bc5d3dff53d41f3de704296f409aafcd9293dc89eb4751cf78935139f891ca7"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "0ab8b3c4dc4c6decdb25664f33c2a4cdd817bf15cbb341278bf22040a2d4760e"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "c6965211f7aafae6579b786ff6099448e6a320b79e82f048a78ba8f1c01c1fb1"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "e2c81a8e6cc4a38d9489104c826d9847545a5836262c05cc4794a550d64d7722"
    end
  end
