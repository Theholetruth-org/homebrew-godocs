class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "6ea73a0df99e6bcc41c3a8a0cb836b02d12b5710bc72ee8ce6231e392e70b557"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "a3d398413cfe2f41a9ac4dfb8c8e72c5c808367aa238a35b12b6f728ab8a5abd"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "aea0627a0ef28ca0f4457f33c637113d7520476a8c0e4e40bd35ebe70005ffed"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "2e961672ca3102817565e85095e587ae8ab7abb88cfa49e61c5456a92dacdaba"
    end
  end
