class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "79268c928030b4d2e8c15fcda9c390f6f5671615d523387c6cc0dac1311943b0"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "573d1cac4218eb95637a58571b9589ffcbaa53ae61d947b1353df876255beb40"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "1b641745d55fc8ab470fce3840bda3264fd429555ff90ffdefba817e72d06d2c"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "d581a9b8d39f2e5e8126bbd71ea70dd7e5cf0161ed87e8c87759473b3078408b"
    end
  end
