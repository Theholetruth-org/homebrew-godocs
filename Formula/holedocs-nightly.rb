class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "0d9d6edef8174596bdf129b3143c9a711a5bd95446f0f3a57155b52e7dcce60c"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "2ac5733a07893fdf2f01848be69d8f07372b1b820cfa3b226d2528bef5f87a8c"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "45db1a5e94963ad816cc53c3a5d28dad4a4ca66e3817d424254d2e604a262856"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "3ed10ab0e61ca0bf26ee92a6cee75a234ce7372967a4fed1f0ad46e86a63afa6"
    end
  end
