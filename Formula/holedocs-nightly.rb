class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "1cc46a19a0b4093a9d0ee34bc6a73d30bffdadd52d153c536c7b8f4e0bde94e2"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "43059236f5982206dd8d344fb3a070d8dbe21d0a94bb98229cb0f945520a75a5"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "0edfe93dc2a4fc856fb6530835e3304b654baf3f23d6638d4761b986aff8d939"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "092dea5d2f5c08c489e72ac6aababb3d54b2517e800a3ebbb98aca88619da7bf"
    end
  end
