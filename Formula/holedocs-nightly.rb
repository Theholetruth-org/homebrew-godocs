class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "a99440a0effe19d1d3a57a644871a6c581b080a4576198a1138d24738ace17d4"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "94e37f03f52fb3c0eef3f486e37d32904c8d7e25fe4ce0720c8b14d514451f3c"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "3ea76f3a27af013d5e67049c9ced9a4a3a331680535a0bb55b0722e12a23541d"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "8d544bf629bce5d1334b372005491da8d2c284451596eb0ec2ba00e0fda2ec55"
    end
  end
