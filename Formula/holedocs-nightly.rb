class HoledocsNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "cf642718685cbfc538f4b170f26ae0f2945c14f93e291f8427cdfe6f8f4095eb"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-macos-amd64.tar.gz"
      sha256 "156047e5b6a288866e5bdbb01ea378f3dcf19181a72b57ccd8fc13a4f270fd0c"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "cb62ed75ce9300e811da4e5f9880b088ab8dc325852b448559bccc73e93c2ce2"
    else
      url "https://github.com/Theholetruth-org/Hole-GoDocs/releases/download/nightly/godocs-nightly-linux-amd64.tar.gz"
      sha256 "f74c1926fd99bc1ee4e6eeaefc37f40ed80b217a28ca43402cdeed07ab3e4a04"
    end
  end
